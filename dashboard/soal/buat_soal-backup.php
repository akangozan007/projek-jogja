                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <!-- input jumlah soal -->
                                <div class="form-check">
                                    <input type="number" class="form-control" name="sumInput" id="sumInput" placeholder="Jumlah Soal" aria-label="Jumlah Soal" aria-describedby="basic-addon2">
                                </div>
                                <!-- ./input jumlah soal -->
                                <div class="form-check">
                                    ...
                                    <div class="container-fluid">
                                        <div class="form-group">
                                            ...
                                            <div class="form-check form-check-primary" id="pilgan-form" style="display: none;">
                                                <h2 class="nomorsoal pb-2 border-bottom">Soal</h2> 
                                                <!-- <textarea name="pertanyaan_pilgan[]" id="" class="textareapg p-5"></textarea> -->
                                                <textarea name="question[]" placeholder="Masukkan pertanyaan" class="textareapg p-5"></textarea>
                                                <br>
